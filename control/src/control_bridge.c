...
void cntrl_bridge_inf_delegate_init(cntrl_bridge *bridge, double timestep)
{
    ...
    bridge->inf->cntrl_init(bridge->proxy, &bridge->inf->data, timestep);
}
