...
int main()
{
    ...
    const vec3 axis_rot_init = {1, 0, 0};
    const quat rot_init = quat_from_axis(&axis_rot_init, 0 /*45.0 / 180 * M_PI*/);
    ...
    vec3 comm_ang_vel = vec3_init(0, 0, 0); // currently serves no purpose
